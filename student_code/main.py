...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_image_feature_dir', type=str, default=None)
    ...
    parser.add_argument('--test_image_feature_dir', type=str, default=None)
    ...
    experiment_runner = experiment_runner_class(train_image_dir=args.train_image_dir,
                                                ...
                                                train_image_feature_dir=args.train_image_feature_dir,
                                                test_image_dir=args.test_image_dir,
                                                test_question_path=args.test_question_path,
                                                test_annotation_path=args.test_annotation_path,
                                                test_image_feature_dir=args.test_image_feature_dir,
