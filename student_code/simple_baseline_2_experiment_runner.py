from student_code.simple_baseline_net_2 import SimpleBaselineNet2
from student_code.experiment_runner_base import ExperimentRunnerBase
from student_code.vqa_dataset import VqaDataset

import torch

class SimpleBaseline2ExperimentRunner(ExperimentRunnerBase):
    """
    ...
    def __init__(self, train_image_dir, train_question_path, train_annotation_path, train_image_feature_dir,
        ...
        if(train_image_feature_dir == None):
            model = SimpleBaselineNet2(question_dict_size, answer_dict_size, word_feature_size)
        else:
            model = SimpleBaselineNet2(question_dict_size, answer_dict_size, word_feature_size, True)
